...
<img width="421" height="35" alt="image" src="https://github.com/user-attachments/assets/4bb45df9-09cb-4d43-8158-f5e3f3881efd" />
...
Guesser(user 2): (becomes the host of the next round)
...
The players can then quit the game by typing `quit`.
